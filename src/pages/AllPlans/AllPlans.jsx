...
function AllPlans() {
  ...
  return (
    <div
      ...
      {/* current plans */}
      <div className=" lg:w-[70%] w-[95%] lg:h-[80%] h-[92%] flex flex-col items-center justify-start  lg:gap-y-28 gap-y-20 pb-3 lg:pb-5 ">
        {/* title and  filters  */}
          ...
          <div className=" lg:w-auto w-full justify-end items-center gap-x-10  gap-y-4 flex flex-col lg:flex-row    ">
            <div className="lg:w-auto w-full lg:min-w-[330px]  flex justify-between items-center relative  gap-x-3 flex-nowrap ">
              ...
              <input
                name="title"
                placeholder="جستجو"
                className=" w-auto min-w-[240px] h-[35px] rounded-lg   border border-green-1100 focus:ring-0 focus:outline-none pr-4 placeholder:text-gray-200 text-gray-700 placeholder:text-xs text-sm "
                onChange={(e) => {
        ...
        <div className="w-full flex justify-start lg:gap-y-20 gap-y-12  items-center flex-col lg:min-h-[600px] ">
          <div className="w-full flex flex-nowrap lg:flex-row flex-col justify-center gap-10 lg:gap-x-16 items-center  ">
            {currentPlans?.isloading ? (
              ...
              <span className="w-full text-base font-bold text-gray-700 text-center items-center">

    ...
    <div className="w-full flex flex-col items-start justify-between h-[400px]">
      ...
      <div className="w-full flex flex-col items-center justify-start gap-y-10 ">
        ...
        <div className="w-full flex flex-col gap-y-1  h-auto justify-center items-center ">
          ...
          <input
            name="title"
            className=" focus:border-[#E0E0E0] focus:ring-0 focus:outline-none   placeholder:text-[#CCCCCC] placeholder:text-xs w-full h-[42px] pr-2 rounded-lg  border text-sm text-gray-700  border-[#E0E0E0] "
            value={details?.title}
      ...
      <button
        ...
        className={`bg-green-1000 rounded-md text-white font-medium text-sm   flex justify-center items-center text-center w-[50%] h-[42px] ${
          !disable && 'opacity-65'
        } `}>
        ثبت و ادامه
      </button>

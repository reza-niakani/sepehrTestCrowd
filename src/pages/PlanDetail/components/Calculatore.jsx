    ...
    <div
      ...
      <div className="w-[90%] flex flex-col items-center gap-y-4 justify-start  ">
        ...
        <input
          ...
          className="w-full flex justify-start  text-sm text-gray-700 text-center focus:outline-none focus:ring-0 border border-green-1100 rounded-large h-[42px] focus:border-green-1100"
        />
      </div>
      <span

            ...
            <div
              ...
              <div className="flex flex-col items-center justify-start">
                <input
                  ...
                  disabled
                  readOnly
                  className={`focus:outline-none focus:ring-0 text-green-1000 rounded-full lg:w-6 w-4 lg:h-6 h-4 border ${
                    item?.status ? ' border-green-1000' : ' border-gray-700'
                  }`}
                />
                ...
                {index !== calender?.length - 1 && (
                  <div
                    className={`h-auto min-h-6   flex flex-grow border-r ${
                      item?.status ? 'border-green-1100' : 'border-gray-500'
                    }`}
                  />
                )}
              </div>
              <div className="w-full flex justify-between items-center h-6 gap-x-2 lg:text-sm text-xs text-gray-700 font-medium">

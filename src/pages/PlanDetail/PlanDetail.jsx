...
function PlanDetail() {
  ...
  const [borseCode, setBorseCode] = useState(false);
        ...
        <div className="w-full h-auto flex flex-col justify-start items-center gap-y-16">
          ...
          <div className="lg:w-[80%] w-[95%] flex  flex-col  justify-start items-center lg:border-t border-gray-100 ">
            <div className="w-full flex justify-between items-center ">
              <span className="lg:text-xl text-base font-black text-start">سایر سبد ها</span>
              <Link
                to="/all_plans"
          ...
          <div className="lg:w-[70%] w-[95%] flex flex-col justify-start lg:gap-y-10 gap-y-7 items-center text-gray-700 ">
            ...
            <span className="lg:text-lg text-sm text-center font-extrabold w-[90%] ">
              صرفا کافی است اطلاعات خود را وارد کنید تا کارشناسان ما با شما تماس بگیرند.{' '}
            </span>
            {/* input field */}
            <form
              ...
              <input
                ...
                className="w-[95%] lg:w-[40%] flex justify-start  text-sm text-gray-700 pr-4 text-start placeholder:text-gray-400 focus:outline-none focus:ring-0 border border-green-1100 rounded-large h-[42px] focus:border-green-1100"
              />
              {/* <div className="lg:w-auto w-[90%] justify-between items-center gap-x-5 flex">
                ...
                <div className="w-auto flex items-center justify-start gap-x-2">
                  ...
                  <input
                    ...
                    className={`focus:outline-none focus:ring-0 text-green-1000 lg:rounded-lg rounded-md lg:w-6 w-4 lg:h-6 h-4 border border-gray-700
                    `}
                  />
                </div>
                <div className="w-auto flex items-center justify-start gap-x-2">
              ...
              <button
                ...
                className={`w-[95%] lg:w-[15%] h-[42px] bg-green-1000 rounded-md focus:outline-none focus:border-0 focus:ring-0 flex justify-center items-center text-sm font-medium text-white  ${

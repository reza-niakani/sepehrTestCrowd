      ...
      <div className="w-full flex flex-col items-center  gap-y-10">
        ...
        <div className="w-full flex flex-col gap-y-1  h-auto justify-center items-center ">
          ...
          <CustomDropDown
            width="w-full bg-white h-[42px] "
            options={[
              { name: ' تامین سرمایه در گردش جهت خرید مواد اولیه', key: 1 },
              { name: ' تامین سرمایه در گردش جهت تولید و فروش محصولات', key: 2 },
              { name: ' تامین سرمایه در گردش جهت واردات کالا', key: 3 },

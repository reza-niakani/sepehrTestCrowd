  ...
  return (
    <div className="w-full flex flex-col items-start justify-start gap-y-10 ">
      ...
      <div className="w-full flex flex-col gap-y-1  h-auto justify-center items-center ">
        ...
        <textarea
          name="planTitle"
          placeholder="به طور مثال طرح تامین سرمایه در گردش بخش توسعه و تکنولوژی سبدگردانی ویستا"
          className=" focus:border-[#E0E0E0] focus:ring-0 focus:outline-none   placeholder:text-[#CCCCCC] placeholder:text-xs placeholder:p-3 w-full h-[90px] rounded-lg  border text-sm text-gray-700  border-[#E0E0E0] resize-none"
          value={details?.title}
      ...
      <div className="w-full flex flex-col gap-y-1  h-auto justify-center items-center ">
        ...
        <input
          name="goal"
          placeholder=""
          className=" focus:border-[#E0E0E0] focus:ring-0 focus:outline-none  pr-3  placeholder:text-[#CCCCCC] placeholder:text-xs placeholder:p-3 w-full h-[42px] rounded-lg  border text-sm text-gray-700  border-[#E0E0E0] resize-none"
          maxLength={30}
          onChange={(e) => {
      ...
      <button
        ...
        className={`bg-green-1000 rounded-md text-white font-medium text-sm   flex justify-center items-center text-center w-[50%] h-[44px] ${
          !disable && 'opacity-65'
        } `}>
        ثبت و ادامه
      </button>

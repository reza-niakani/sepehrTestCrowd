  ...
  return (
    <div className="w-[90%] flex flex-col items-center justify-between h-[400px] pt-8 gap-y-5">
      ...
      <div className="w-full relative flex justify-start flex-col items-end gap-y-2  ">
        <span className="text-sm text-gray-700 w-full text-start ">
          مبلغ سرمایه گذری رامشخص کنید
        </span>{' '}
        <input
        ...
        <span className={`lg:text-sm  text-xs  font-medium  w-full text-start  text-gray-700 `}>
          قیمت هر واحد (ریال): {data?.unitAmount && Number(data?.unitAmount).toLocaleString()}
        </span>
      </div>

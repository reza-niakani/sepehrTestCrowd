    ...
    <div className="w-full flex flex-col justify-start items-center gap-y-2">
      ...
      <div
        ...
        dangerouslySetInnerHTML={{
          __html: `«تامین مالی جمعی» به‌عنوان روشی برای سرمایه‌گذاری، مشابه سایر روش‌ها، متضمن ریسک‌هایی برای تامین‌کننده است و تامین سرمایه بانک ملت به‌عنوان عامل مجاز، برخی از خطرات این سرمایه‌گذاری را در اجرای مواد ۲۹ و ۳۰ «دستورالعمل تامین مالی جمعی»، به شرح زیر به اطلاع تامین‌کنندگان محترم می‌رساند:<br><br>
        ...
        <div className="w-auto flex flex-col  items-start lg:h-[48px] h-[38px] justify-between gap-y-2  ">
          ...
          <div
            ...
            <input
              ...
              className="w-4 h-4 focus:outline-none focus:ring-0  text-[#364A87] border border-[#364A87] rounded-sm "
            />
            <span className="text-nowrap text-gray-700 text-xs">پذیرش مفاد قرارداد سه جانبه </span>
          </div>
        </div>
      </div>
    </div>

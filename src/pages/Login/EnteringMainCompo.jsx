        ...
        return (
          <div className="w-full flex  flex-col justify-start items-center h-full gap-y-5 ">
            ...
            <a
              target="_blank"
              rel="noreferrer"
              className=" lg:h-12 h-10 rounded-md text-center items-center flex justify-center text-sm  border-gray-700 border w-full text-gray-500   lg:pt-0  bg-gray-150 "
              href="https://profilesejam.csdiran.ir/session">
              رفتن به سایت سجام
            </a>
            <button
              className="rounded-large text-sm lg:h-[50px] h-[43px] text-green-1000 w-full   shadow-dropShadow2  "
      ...
      <div className="w-full   flex lg:flex-row lg:min-h-[828px] flex-col lg:justify-center justify-start gap-3  items-center h-auto lg:py-0 py-5 ">
        ...
        <div className="lg:w-[50%] w-[95%] h-full flex flex-col  justify-start items-center lg:gap-y-10  gap-y-3 ">
          <div className="w-full flex justify-center items-center  lg:bg-white bg-gray-50 p-2 lg:h-[20%] rounded-large">
            <InlineSVG src={mainLogo} className="lg:w-[270px] lg:h-[65px] w-[125px] h-[30px] " />
          </div>
          {/* form by step */}
              ...
              <div className="w-full flex justify-center items-center gap-0 flex-nowrap">
                ...
                <button
                  ...
                  className={`w-[50%] lg:text-base text-sm  text-center items-start flex justify-center ${
                    controlStep()?.key == 'login' ? 'text-green-1000' : ' text-[#D9D9D9]'
                  } `}>
                  ورود
                </button>
                <button
                  ...
                  className={`w-[50%] lg:text-base text-sm  text-center items-start flex justify-center ${
                    controlStep()?.key == 'register' ? 'text-green-1000' : ' text-[#D9D9D9]'
                  } `}>
                  ثبت‌نام
                </button>
              </div>
                ...
                <div
                  className={`w-[50%] text-center items-start flex justify-center ${
                    controlStep()?.key == 'login'
                      ? 'border-green-1000 border-b-4 rounded-full '
        ...
        <div className="lg:w-[40%] w-[87%] h-full flex flex-col items-center justify-center lg:py-0 py-6 lg:bg-white bg-gray-100 rounded-large">
          {/* desktop */}
          <InlineSVG
            src={banner}
            className="w-fit h-[90%] max-h-[830px] min-h-[520px] object-cover rounded-Radius  lg:block hidden"
          />

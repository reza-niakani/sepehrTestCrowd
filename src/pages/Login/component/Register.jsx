...
function Register({
  ...
  return (
    <div className=" w-full  flex flex-col h-full justify-start  items-center gap-y-10  py-5 ">
      <span className=" text-gray-700 font-black lg:text-lg text-base text-start w-full ">
      ...
      <form
        ...
        <div className="w-full flex flex-col justify-start items-center h-auto gap-y-2">
          <label
            htmlFor="nationalId"
            className=" text-gray-700 w-full lg:justify-start items-center lg:text-sm  text-xs font-medium">
            کد ملی | شناسه ملی{' '}
          </label>
          <input
            id="nationalId"
        ...
        <div className="w-full  items-end flex justify-center  gap-2 ">
          <div className="w-[50%] flex flex-col justify-start items-center h-auto gap-y-2">
            ...
            <input
              ...
              inputMode="numeric"
              className=" w-full border border-gray-70 rounded-large text-center    text-sm  focus:ring-0 focus:outline-none   text-gray-700 h-[42px] "
            />
          </div>
        ...
        {error && (
          <span className="w-full text-center justify-start items-center  text-red-600 text-sm ">
            {error}
          </span>
        )}{' '}
        <button

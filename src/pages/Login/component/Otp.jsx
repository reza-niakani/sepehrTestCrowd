...
function Otp({ step, setStep, otp, setOtp, nationalId, error }) {
  ...
  return (
    <div className=" w-full flex flex-col h-full justify-center  items-center gap-y-10  ">
      <span className=" text-gray-700 font-black lg:text-lg text-base w-full text-start ">
      ...
      <div className="w-full flex flex-col justify-start  gap-y-10  ">
        ...
        {errorSend ? (
          ...
          <div className="w-full flex flex-col justify-center items-start h-auto gap-y-7">
            <span className=" w-full text-start justify-start  flex  font-medium lg:text-base text-xs    text-gray-700   ">
                ...
                renderInput={(props) => (
                  <input
                    ...
                    className={`focus:outline-none focus:none focus:border-none focus:ring-green-700  ${
                      !error
                        ? 'border-green-1000 text-green-1000 '
            ...
            <div
              className={`w-[90%] flex items-center  gap-x-5  lg:text-sm text-xs font-medium text-gray-700 justify-between py-2 `}
              style={{ direction: 'rtl' }}>
              {timer == 0 && (
                <span className=" cursor-pointer w-[30%] text-green-1000  " onClick={SendOtpCode}>
                  {' '}
                  ارسال مجدد
                </span>
              )}

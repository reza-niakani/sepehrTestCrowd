    ...
    <div className="w-full flex flex-col items-center justify-start gap-y-1">
      ...
      <div className="w-full rounded-t-[20px] rounded-b-md  border border-[#E0E0E0]  bg-white flex  min-h-[200px] h-auto flex-col items-center justify-center  gap-y-5  ">
        ...
        <div className="w-[80%] flex justify-start gap-x-5 items-center ">
          ...
          <span className="text-sm text-gray-700 font-medium ">مجموع دارایی ها</span>
        </div>
        {/* divider */}
        ...
        <div className="w-full flex flex-col gap-y-3 items-center justify-center ">
          ...
          <span className="w-full text-center text-gray-700 text-base  font-bold ">
      ...
      <Link
        to="/all_plans"
        className="w-full bg-white drop-shadow-md text-center flex justify-center gap-x-2 items-center rounded-b-[20px] rounded-t-md  h-[40px] text-base font-bold text-green-1000 ">

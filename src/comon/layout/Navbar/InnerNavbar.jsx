    ...
    <div className="w-full flex  justify-center  lg:h-20   h-16  items-center bg-white">
      <div className="lg:w-[75%] w-[90%] flex justify-between items-center  ">
        ...
        <InlineSVG
          src={logo}
          onClick={() => navigate('/')}
          className=" lg:w-[180px] lg:h-[42px] w-[155px] h-[36px] cursor-pointer "
        />
        <div className="w-auto justify-end items-center gap-x-5 flex  flex-nowrap ">
          ...
          <div className="lg:flex  hidden justify-start gap-x-2 items-center  w-auto">
            <span className="text-gray-500 text-sm  text-nowrap">تاریخ روز :</span>
            <span className="text-gray-700 text-sm border border-green-1000  flex justify-center items-center text-center rounded-lg py-2 px-3   ">

      ...
      <div className="h-full w-[95%] flex flex-nowrap justify-between items-center  ">
        <div className=" flex w-auto lg:gap-x-4 items-center h-full">
          ...
          <InlineSVG
            onClick={() => navigate('/')}
            src={mainLogo}
            className="lg:w-[175px] lg:h-[40px] w-[125px] h-[30px] object-cover cursor-pointer "
          />
        ...
        <Link
          ...
          className="lg:flex hidden items-center text-center justify-center  text-white  bg-blue-1000 w-[125px] h-[38px] text-sm font-black rounded-lg  ">

  ...
  return (
    <div className="lg:w-[330px] w-[290px] flex flex-col items-center bg-transparent relative min-h-[450px] h-auto ">
      ...
      <Link
        ...
        className="w-full text-sm font-bold lg:text-base h-[43px] mt-[-5px] flex justify-center items-center text-center text-green-1000 bg-white drop-shadow-md rounded-b-[22px]">
        جزئیات طرح
      </Link>
    </div>
  );

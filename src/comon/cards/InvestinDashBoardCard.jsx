  ...
  return (
    <div className="lg:w-[330px] w-[290px] flex flex-col items-center bg-transparent relative min-h-[440px] ">
      ...
      <div
        ...
        <span className="w-[90%] bg-gray-100 text-center text-gray-700 text-xs font-semibold rounded-Radius h-[30px] flex justify-center items-center">
          زمان باقی مانده
        </span>
      ...
      <div className="w-full flex justify-between items-center mt-[-5px]">
        <Link
          ...
          className="w-[49%] text-sm font-bold lg:text-base h-[43px] flex justify-center items-center text-center text-green-1000 bg-white  drop-shadow-md rounded-br-[22px]">
          جزئیات طرح
        </Link>
        <button
          onClick={() => setModal({ type: 'buyUnit', data: data })}
          className="w-[49%] text-sm font-bold lg:text-base h-[43px] flex justify-center items-center text-center bg-green-1000 text-white  drop-shadow-md rounded-bl-[22px]">
          سرمایه گذاری
        </button>
      </div>
    </div>

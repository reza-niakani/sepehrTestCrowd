...
const TextSplitter = ({ text, stepToshow = 1 }) => {
  ...
  return (
    <div className="w-full flex flex-col justify-start items-center lg:gap-y-9 gap-y-6">
      ...
      <p
        className="lg:text-xl text-xs text-gray-700 text-start w-full"
      ...
      <div className="w-full flex items-center justify-center h-auto">
        {currentPart < textParts.length ? (
          <button
            onClick={showMore}
            dir="ltr"
            className="lg:bg-transparent lg:w-[155px] w-[120px] lg:h-[40px] h-[38px] bg-gray-600 lg:text-gray-700 text-white lg:text-xl text-xs lg:font-bold font-medium flex justify-center items-center lg:gap-x-3 gap-x-2 focus:outline-none focus:ring-0 focus:border-none rounded-lg">

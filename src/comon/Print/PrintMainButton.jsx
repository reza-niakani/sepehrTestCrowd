  ...
  return (
    <div className="col-span-1 w-full flex items-center justify-center ">
      <ReactToPrint
        ...
        trigger={() => {
          return (
            <button className="w-[180px] lg:h-[48px] h-[40px]  bg-green-1000 text-white text-center flex justify-center rounded-md  items-center text-sm font-semibold  focus:outline-none focus:ring-0 focus:border-0 ">
              چاپ گواهی
            </button>
          );
        }}

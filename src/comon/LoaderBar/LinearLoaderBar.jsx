...
const LinearLoaderBar = ({ total, amountRaised, endDate, neededAmount, positionOfPointer }) => {
  ...
  return (
    <div className="relative w-full flex flex-col items-center py-5 gap-2">
      <div className=" w-[98%] flex justify-between  items-center lg:text-lg text-xs font-medium text-gray-500 ">
      ...
      <div className=" w-[98%] flex lg:flex-row flex-col  lg:justify-between justify-start gap-y-2  lg:items-center items-start lg:text-lg text-xs font-medium text-gray-500 ">

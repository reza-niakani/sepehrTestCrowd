...
export const DataProvider = ({ children }) => {
  ...
  // const GetCompanyStatisticalInformation = async () =>
  //   await Axios.get('InvestmentPlans/CumulativeInformation')
  ...
  const GetUserStatistics = async () =>
    await Axios.get('/Accounts/GetUserStatistics')
      .then((res) => setUserStatistics(res?.data))
      .catch(() => setUserStatistics(false));

    ...
    <div className="w-full  flex-col flex items-center gap-y-10  justify-start lg:justify-center  lg:mt-0 mt-16  lg:bg-[rgb(242, 252, 244)] relative h-full justify-center   rounded-t-large ">
      ...
      <div className="w-full flex flex-col  h-auto justify-center items-center   ">
        <div className="flex flex-col w-full mt-0 gap-y-5   rounded-lg p-4 pt-8 lg:p-8 justify-start items-center ">
          ...
          <div className={`flex justify-center text-center text-base text-red-600 w-full`}>
            {text}
          </div>
          {sejamText && (
            <p className="lg:w-full w-full  text-sm text-gray-700 text-justify justify-center items-center  ">
              {sejamText}
            </p>
          )}{' '}
        </div>
      ...
      {btn && (
        <button
          ...
          className="border w-full border-red-600 text-base text-center h-[40px] justify-center items-center flex rounded-md  bg-gray-600 text-white   ">
          تایید{' '}
        </button>
      )}
    </div>

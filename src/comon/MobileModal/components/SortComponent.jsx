  ...
  return (
    <div className="w-full h-auto bg-transparent flex flex-col items-center min-h-[200px] justify-start gap-y-7 pb">
      ...
      <div
        ...
        <span className="text-sm font-medium  text-gray-700 text-start">جدید ترین طرح</span>
        <input
          checked={sort == 'createDate'}
          type="checkbox"
          className="rounded-full text-gray-700  focus:ring-0 focus:border-none focus:outline-none "
        />
      </div>
      <div
        onClick={() => setSort('totalProfitRate')}
        className="w-[90%] flex items-center justify-between ">
        <span className="text-sm font-medium  text-gray-700 text-start">پرسود ترین طرح</span>
        <input
      ...
      {/* <div onClick={() => setSort()} className="w-[90%] flex items-center justify-between ">
        <span className="text-sm font-medium  text-gray-700 text-start">پربازدید ترین طرح</span>
        <input
          type="checkbox"
          className="rounded-full text-gray-700  focus:ring-0 focus:border-none focus:outline-none "
        />
